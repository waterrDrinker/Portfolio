...
const GithubIcon: FC<GithubIconProps> = ({ options }) => {
  return (
    ...
    >
      <g clipPath="url(#clip0_897_2132)">
        <g clipPath="url(#clip1_897_2132)">
          <path
            clipRule="evenodd"
            ...
            fill={options?.elementsColor?.primaryColor}
            fillRule="evenodd"
          />
        </g>
      </g>
      <defs>
        <clipPath id="clip0_897_2132">
          <rect fill="white" height="24" width="24" />
        </clipPath>
        <clipPath id="clip1_897_2132">
          <rect fill="white" height="23.5102" width="24" />
        </clipPath>
      </defs>
    </svg>
  );
